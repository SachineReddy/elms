...
$sql="update employees_table set FirstName=:fname,LastName=:lname,Gender=:gender,Dob=:dob,Department=:department,Address=:address,City=:city,Country=:country,Phonenumber=:mobileno where EmailId=:eid";
    ...
    <body>
       ...
       <?php include('includes/sidebar.php');?>
        <main class="mn-inner">
            <div class="row">
                <div class="col s12">
                    <div class="page-title" style="color: #687864;font-size: 20px;font-weight: bolder;">Update Employee Details</div>
                </div>
                <div class="col s12 m12 l12" style="padding-left: 70px; padding-right: 70px;">
                    <div class="card">
                                            ...
                                            <div class="row" style=" width: max-content;">
                                                <div class="col m6" style="padding-left: 50px;padding-right: 150px;" align="center">
                                                    <div class="row">
                                                        <?php 
                                                        $eid=$_SESSION['emplogin'];
                                                        $sql = "SELECT * from  employees_table where EmailId=:eid";
                                                        $query = $dbh -> prepare($sql);
                                                        $query -> bindParam(':eid',$eid, PDO::PARAM_STR);
                                                        $query->execute();
                                                ...
                                                <!--<div class="col m6"> 
                                                    <div class="row">-->
                                                        ...
                                                        <div class="input-field col s12" align="center">
                                                            <button type="submit" name="update"  id="update" class="waves-effect waves-light btn  m-b-xs"style="background-color:#31708E;">UPDATE</button>
                                                        </div>
