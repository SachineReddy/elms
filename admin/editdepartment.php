...
$sql="update departments_table set DepartmentName=:deptname,DepartmentCode=:deptcode,DepartmentShortName=:deptshortname where id=:did";
  ...
  <?php include('includes/header.php');?>
       ...
       <?php include('includes/sidebar.php');?>
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title" style="color: green;">Update Department Details</div>
                    </div>
...
<?php 
$did=intval($_GET['deptid']);
$sql = "SELECT * from departments_table WHERE id=:did";
$query = $dbh -> prepare($sql);
$query->bindParam(':did',$did,PDO::PARAM_STR);
$query->execute();
