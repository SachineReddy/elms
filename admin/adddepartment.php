...
$sql="INSERT INTO departments_table(DepartmentName,DepartmentCode,DepartmentShortName) VALUES(:deptname,:deptcode,:deptshortname)";
...
.succWrap{
 ...
 <input id="deptcode" type="text" name="deptcode" class="validate" autocomplete="off" required>
                                                <label for="password">Enter Department Code</label>
                                            </div>
                                        <div class="row">
                                            <div class="input-field col s12">
...
<input id="departmentshortname" type="text"  class="validate" autocomplete="off" name="departmentshortname"  required>
                                                <label for="deptshortname">Enter Department Short Name</label>
                                            </div>
