...
$username=$_SESSION['emplogin'];
    $sql ="SELECT Password FROM employees_table WHERE EmailId=:username and Password=:password";
...
if($query -> rowCount() > 0)
{
$con="update employees_table set Password=:newpassword where EmailId=:username";
